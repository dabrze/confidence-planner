...
#### **Map of usage**
'''
home_text_2 = '''#### **More insightfull about available methods**
...
### **References**
 ...
 - 1. Blum, A., Kalai, A., Langford, J.: Beating the hold-out: Bounds for k-fold and
    progressive cross-validation. In: Ben-David, S., Long, P.M. (eds.) Proceedings of
    the Twelfth Annual Conference on Computational Learning Theory, COLT 1999,
    Santa Cruz, CA, USA, July 7-9, 1999. pp. 203–208. ACM (1999)
 - 2. Clopper, C.J., Pearson, E.S.: The use of confidence or fiducial limits il-
    lustrated in the case of the binomial. Biometrika 26(4), 404–413 (1934),
    http://www.jstor.org/stable/2331986
 - 3. Langford, J.: Tutorial on practical prediction theory for classification. J. Mach.
    Learn. Res. 6, 273–306 (2005)
 - 4. Puth, M.T., Neuh ̈auser, M., Ruxton, G.: On the variety of methods for calculating
    confidence intervals by bootstrapping. The Journal of animal ecology 84 (06 2015).
    https://doi.org/10.1111/1365-2656.12382
 - 5. Wilson, E.B.: Probable inference, the law of succession, and statistical infer-
...
wilson_text = '''Function takes number of samples, obtained accuracy and confidence.
    Returns confidence interval for the given confidence as well as confidence intervals 
    for 90%, 95%, 98% and 99% confidences.'''
